...
public class ProjectModel implements ProjectContract.model {
    @Override
    public void getTreeData(String url, ProjectModelCallback.ProjectTreeCallback callback) {
    ...
    @Override
    public void getArticleData(String url, ProjectModelCallback.ProjectArticleCallback callback) {
        HttpUtil.sendHttpGetRequest(url, new HttpCallbackListener() {
            @Override
            public void onResponse(String response) {
