...
public class ArticleRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final ArrayList<IndexArticleBean> aList;
    ...
    public ArticleRecyclerAdapter(ArrayList<IndexArticleBean> aList, ArrayList<BannerBean> bannerList) {
        this.aList = aList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE.REFRESH_VIEW.ordinal()){
            RecyclerView.LayoutParams headerParams = new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, IndexFragment.dpToPx(80));
            headerParams.topMargin = -IndexFragment.dpToPx(80);
            ...
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_index_article, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == VIEW_TYPE.BANNER_VIEW.ordinal()) {
            ...
            IndexArticleBean bean = aList.get(position - 2);
            // 设置值
    ...
    public void setBannerListener(ArticleRecyclerAdapter.BannerListener bannerListener) {
